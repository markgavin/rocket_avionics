...
Begin Menu MenuBar_Main
   ...
   Begin MenuItem FlightMenu
      ...
      AutoEnable = True
      Visible = True
      Begin MenuItem FlightMainWindow
         SpecialMenu = 0
         Index = -2147483648
         Text = "Main Window"
         ShortcutKey = "1"
      ...
      Begin MenuItem FlightCompare
         ...
         Visible = True
      End
      Begin MenuItem FlightSeparator1
         SpecialMenu = 0
         Index = -2147483648
         Text = "-"
         AutoEnabled = True
         ...
         Visible = True
      End
      Begin MenuItem FlightSaveCurrent
         SpecialMenu = 0
         Index = -2147483648
   ...
   Begin MenuItem WindowMenu
      ...
      Begin MenuItem WindowZoom
         ...
         Visible = True
      End
      Begin MenuItem WindowSeparator1
         SpecialMenu = 0
         Index = -2147483648
         Text = "-"
         AutoEnabled = True
   ...
   Begin MenuItem DebugMenu
      ...
      Begin MenuItem DebugConsole
         ...
         Visible = True
      End
      Begin MenuItem DebugSeparator1
         SpecialMenu = 0
         Index = -2147483648
         Text = "-"
         AutoEnabled = True
      ...
      Begin MenuItem DebugPing
         ...
         Visible = True
      End
      Begin MenuItem DebugStatus
         SpecialMenu = 0
         Index = -2147483648
         Text = "Request Gateway Status"
         AutoEnabled = True
         AutoEnable = True
         Visible = True
      End
      Begin MenuItem DebugSeparator2
         SpecialMenu = 0
         Index = -2147483648
         Text = "-"
         AutoEnabled = True
         ...
         Visible = True
      End
      Begin MenuItem DebugSimulateTelemetry
         SpecialMenu = 0
         Index = -2147483648
         Text = "Simulate Telemetry (10 packets)"
         AutoEnabled = True
         AutoEnable = True
         Visible = True
      End
