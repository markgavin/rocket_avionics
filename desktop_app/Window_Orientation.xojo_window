...
#tag WindowCode
		...
		Sub Activate()
		  ...
		  If Not sOrientationModeActive Then
		    ...
		    If Window_Main.pConnection <> Nil And Window_Main.pConnection.IsConnected Then
		      Window_Main.pConnection.SendOrientationMode(Window_Main.pSelectedRocketId, True)
		    End If
	...
	#tag Event
		Sub Close()
		  ...
		  If Window_Main.pConnection <> Nil And Window_Main.pConnection.IsConnected Then
		    Window_Main.pConnection.SendOrientationMode(Window_Main.pSelectedRocketId, False)
		  End If
